...
const Join = () => {
  ...
  return (
    <div className='h-screen  pt-12 -translate-y-4 md:pt-40 bg-black '>
      ...
      <button onClick={()=>navigate("/signup")}  className="group relative h-8 w-40 overflow-hidden rounded-2xl bg-goldx text-lg font-bold border-2 border-orangex text-orangex text-center">JOIN NOW
