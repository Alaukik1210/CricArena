...
const Upcoming = () => {
  ...
  return (
    <div id='tour' className='mt-20'>
        ...
        <span className="hidden md:block absolute left-0 rounded-e-lg h-[4px] w-[150px] bg-gradient-to-r from-transparent to-gold animate-[animate_5s_linear_infinite]"></span>
        <motion.span
        ...
        <div className='bg-ball bg-cover h-full'>
          ...
          <div onClick={() => navigate("/score")} className='overflow-hidden h-[416px] rounded-3xl border-1 hover:border-0.5 m-4 border-goldx cursor-pointer hover:scale-95 ease-in-out duration-300 bg-matches bg-cover bg-no-repeat size-[250px] w-[350px] border-4 md:size-[400px] md:w-[650px] md:mt-20'>
            ...
            <div onClick={() => navigate("/score")} className='overflow-hidden h-[416px] rounded-3xl border-1 hover:border-0.5 m-4 border-goldx cursor-pointer hover:scale-95 ease-in-out duration-300 bg-matches1 bg-cover bg-no-repeat size-[250px] w-[350px] border-4 md:size-[400px] md:w-[650px] md:mt-20'>
              <h1 className='text-gold bg-goldx text-5xl font-cabinet-black font-bold flex justify-center items-baseline mt-[280px]'>Match 2</h1>
              <span className='text-black text-2xl font-cabinet-bold bg-gold flex justify-center'>click here</span>
              <span className='text-gold text-xl font-cabinet-bold pb-2 bg-goldx flex justify-center'>IIT Delhi Vs IIT Roorkee</span>
            </div>
          ...
          <div className='md:flex md:justify-evenly md:m-20 grid-cols-1 m-4'>
            <div onClick={() => navigate("/score")} className='overflow-hidden h-[416px] rounded-3xl border-1 hover:border-0.5 m-4 border-goldx cursor-pointer hover:scale-95 ease-in-out duration-300 bg-matches2 bg-cover bg-no-repeat size-[250px] w-[350px] border-4 md:size-[400px] md:w-[650px]'>
            ...
            <div onClick={() => navigate("/score")} className='overflow-hidden h-[416px] rounded-3xl border-1 hover:border-0.5 m-4 border-goldx cursor-pointer hover:scale-95 ease-in-out duration-300 bg-matches3 bg-cover bg-no-repeat size-[250px] w-[350px] border-4 md:size-[400px] md:w-[650px]'>
