  ...
  return (
    <div className="z-10">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="bg-hero mt-20 md:mt-40 h-[60vh] md:h-[70vh] px-4 sm:px-10 md:px-20 lg:pl-40 flex flex-col justify-center font-display"
      >
        {/* Main Heading */}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="text-white font-extrabold text-3xl sm:text-5xl md:text-6xl lg:text-7xl w-full md:w-[80%] lg:w-[80%]"
        >
        ...
        >
          ...
          <button className="text-lg sm:text-xl font-bold z-10 px-6 sm:px-8 py-2 border-2 border-orangex text-white rounded-2xl">
            Ready To Play?
          </button>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex flex-col sm:flex-row gap-6 mt-8 sm:mt-12 text-center sm:text-left"
        >
          <div className="flex justify-center sm:justify-start gap-6 text-2xl sm:text-3xl font-bold text-orangex">
