...
export default function Tours() {
  ...
  return (
    <div className="bg-black text-white p-10 m-20 mt-28">
      <div className="flex justify-between items-center mb-12">
        <div>
          <h2 className="text-5xl font-bold text-[#FFD070]">Join The Fun</h2>
          <p className="text-gray-400 mt-2">Upcoming cricket events near you</p>
        </div>
        {/* Search Bar */}
        <input
          type="text"
          ...
          className="px-4 py-2 rounded-lg bg-zinc-800 text-white focus:outline-none focus:ring-2 focus:ring-[#FFD070]"
        />
      </div>
